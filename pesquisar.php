<html>
  ...
  <body>
    ...
    <section id="conteudo" style="margin-top: -48px;">
      <a href="consulta.php" style="position: relative; float: left; width: 66px; height: 30px;"><button class="btnEntrar" style="background: #ed2f59;position: relative; float: left; padding: 0px; margin-left: 505%;; margin-right: 100px; width: 66px; height: 30px;a{color: #fff;} a:link, a:visited{text-decoration: none;}">
        Return
      </button></a>
